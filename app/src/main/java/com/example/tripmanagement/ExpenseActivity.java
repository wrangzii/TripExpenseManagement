...
public class ExpenseActivity extends AppCompatActivity {
    ...
    TextView tvNameInfo, tvDestinationInfo, tvDateInfo, tvRiskAssessmentInfo, tvDescriptionInfo, tvTripNecessaryStuff, tvWeatherConditionInfo, tvRdInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tripNecessaryStuff = intent.getStringExtra("trip_necessary_stuff");
        String tripWeatherCondition = intent.getStringExtra("trip_weather_condition");
        String tripRecommendedDestination = intent.getStringExtra("trip_recommended_destination");
        ...
        tvTripNecessaryStuff = findViewById(R.id.tv_trip_necessary_stuff);
        tvWeatherConditionInfo = findViewById(R.id.tv_weather_condition_info);
        ...
        tvTripNecessaryStuff.setText(tripNecessaryStuff);
        // tvRdInfo.setText(tripRecommendedDestination);
        tvWeatherConditionInfo.setText(tripWeatherCondition);
